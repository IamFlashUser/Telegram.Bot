...
{
    /// <summary>Unique identifier for the target chat or username of the target bot, supergroup or channel in the format <c>@username</c>. Channel chats and channel direct messages chats aren't supported.</summary>
